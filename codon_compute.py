...
print("gene numbers of first species:",n_gene1)
print("length of gene of first species",L_gene1)
print("gene numbers of second species:",n_gene2)
print("length of gene of second species",L_gene2)
print("I use Count function in packge collections")
print("G+C percentage of species1:",(G_number1 + C_number1)/L_gene1)
print("G+C percentage of species1:",(G_number2 + C_number2)/L_gene2)
print("G+C percentage of total dataset:",(G_number2 + C_number2 + G_number1 + C_number1 )/(L_gene2 + L_gene1))
print("codon numbers in file 1",returnSum(codon1))
print("codon numbers in file 2",returnSum(codon2))
print("codon frquency", str(codonF))